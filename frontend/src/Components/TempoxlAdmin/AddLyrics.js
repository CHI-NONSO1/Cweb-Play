...
function AddLyrics() {
  ...
  if(songtitle){
    ...
    songName.addEventListener('keypress',getSongId)
   }
  ...
  function getSongId(event){
    ...
    const GetSong = async () => {
      ...
      const resp = await axios.get(`http://localhost:8000/song/name/${songtitle}`);
      setSongid(resp.data.songid)
      setSongtitle(resp.data.songtitle);
      
      if(resp.data === []){
        setSongError("Song  Not Found")
      }
  ...
  const [line70, setLine70] = useState('');
      ...
      const addLyrics = async (e) => {
        ...
        try{
          ...
          await axios.post('http://localhost:8000/lyrics', 
  ...
  return (
    ...
    <div className="wrapper_flexAS">
      <div className="h2parent">
        <h2 className="login_header">Add Lyrics</h2>
      </div>
  ...
  <React.Fragment>
    <Addlyrics >
      <div className="lyrics__header-wrap">
        <h2 className="lyrics_header">Add Lyrics</h2>
      </div>
      <div className="lyrics__header-wrap">
        <h2 className="lyrics_header">{songtitle}</h2>
      </div>
      ...
      <div className="form__group--parent">
        ...
        <div className="form-group__submit--addlyrics">
          ...
          <input type="submit" className="lyrics__btn_submit" onClick={(e) => addLyrics(e)} value="Add" />
