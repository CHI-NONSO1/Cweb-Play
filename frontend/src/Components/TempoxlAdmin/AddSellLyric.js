...
function AddSellLyrics() {
  ...
  const [line70, setLine70] = useState('');
      ...
      const addSellLyrics = async (e) => {
        // prevent the form from refreshing the whole page
        e.preventDefault();

        try{
      
          await axios.post('http://localhost:8000/buylyrics', 
  ...
  return (
      ...
      <div className="form__group--parent">
        ...
        <div className="form-group__submit--addlyrics">
          ...
          <input type="submit" className="lyrics__btn_submit" onClick={(e) => addSellLyrics(e)} value="Add" />
